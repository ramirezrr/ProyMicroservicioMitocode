...
INSERT INTO LICENCIA (ID, DELETED, ESTADO, FECHA_EMISION, FECHA_PROXIMA_VENCIMIENTO, FECHA_ULTIMA_RENOVACION, FECHA_VENCIMIENTO, TIPO_LICENCIA_ID, TITULAR_ID)
VALUES (licencia_seq.NEXTVAL, 0, 'ACTIVO', TO_DATE('2024-01-15', 'YYYY-MM-DD'), TO_DATE('2025-01-15', 'YYYY-MM-DD'), TO_DATE('2024-01-15', 'YYYY-MM-DD'), TO_DATE('2026-01-15', 'YYYY-MM-DD'), 1, 1);

INSERT INTO LICENCIA (ID, DELETED, ESTADO, FECHA_EMISION, FECHA_PROXIMA_VENCIMIENTO, FECHA_ULTIMA_RENOVACION, FECHA_VENCIMIENTO, TIPO_LICENCIA_ID, TITULAR_ID)
VALUES (licencia_seq.NEXTVAL, 0, 'ACTIVO', TO_DATE('2024-02-20', 'YYYY-MM-DD'), TO_DATE('2025-02-20', 'YYYY-MM-DD'), TO_DATE('2024-02-20', 'YYYY-MM-DD'), TO_DATE('2026-02-20', 'YYYY-MM-DD'), 2, 2);

INSERT INTO LICENCIA (ID, DELETED, ESTADO, FECHA_EMISION, FECHA_PROXIMA_VENCIMIENTO, FECHA_ULTIMA_RENOVACION, FECHA_VENCIMIENTO, TIPO_LICENCIA_ID, TITULAR_ID)
VALUES (licencia_seq.NEXTVAL, 0, 'INACTIVO', TO_DATE('2024-03-25', 'YYYY-MM-DD'), TO_DATE('2025-03-25', 'YYYY-MM-DD'), TO_DATE('2024-03-25', 'YYYY-MM-DD'), TO_DATE('2026-03-25', 'YYYY-MM-DD'), 3, 3);
